...
export const podcastEpisodes: PodcastEpisode[] = [
  // ── Season 5 (2026) ──────────────────────────────────────────
  {
    ...
    summary: "Blaise Agüera y Arcas discusses intelligence evolution and Project Suncatcher's space-based solar energy research.",
    duration: "00:21:36",
    pubDate: "2026-03-11",
  ...
  },
  {
    ...
    summary: "Anastasia Volkova, CEO of Regrow Ag, and Brad Zamft, CEO of Heritable Agriculture, harness AI to keep soil and crops resilient.",
    duration: "00:23:06",
    pubDate: "2026-03-04",
  ...
  },
  {
    ...
    summary: "Lucia Tian addresses carbon-free power solutions including geothermal and nuclear partnerships.",
    duration: "00:26:55",
    pubDate: "2026-02-25",
  ...
  },
  {
    ...
    summary: "Tara Chklovski, CEO of Technovation, explains how the global organization empowers girls to use AI to solve real-world problems.",
    duration: "00:17:32",
    pubDate: "2026-02-18",
  ...
  },
  {
    ...
    summary: "Oana Jinga, co-founder of Dexory, explains how AI has enabled her company's robots to shine light on warehouses.",
    duration: "00:22:34",
    pubDate: "2026-02-11",
  ...
  },
  {
    ...
    summary: "Partha Ranganathan — one of the architects of modern data center design — explains how Google's data centers have embraced efficiency.",
    duration: "00:21:12",
    pubDate: "2026-02-04",
  ...
  },
  {
    ...
    summary: "Wendy Tan White, CEO of Intrinsic, explains how the company is embracing AI to make manufacturing more accessible.",
    duration: "00:19:58",
    pubDate: "2026-01-28",
  ...
  },
  {
    ...
    summary: "Multimedia artist King Willonious discusses his creative process, including the story behind his AI-generated hit song.",
    duration: "00:19:41",
    pubDate: "2026-01-21",
  ...
  },
  {
    ...
    summary: "Recursion CEO Chris Gibson explains how the company combines high-tech lab experiments with advanced computing to map human biology.",
    duration: "00:21:40",
    pubDate: "2026-01-14",
  ...
  },
  {
    ...
    summary: "MIT professor and author Andrew McAfee draws the throughline from early industrial revolutions to the AI revolution.",
    duration: "00:27:25",
    pubDate: "2026-01-07",
  ...
  // ── Season 4 (2024) ──────────────────────────────────────────
  {
    ...
    summary: "Technology advances are helping recyclers convert hard-to-recycle waste into a valuable feedstock.",
    duration: "00:30:10",
    pubDate: "2024-11-06",
  ...
  },
  {
    ...
    summary: "Data centers and the AI they enable are helping to mitigate the invisible threats of heat and air pollution.",
    duration: "00:35:51",
    pubDate: "2024-10-30",
  ...
  },
  {
    ...
    summary: "Data-driven tools are helping farmers use less water and improve yields while AI gets excess food to those who need it most.",
    duration: "00:35:59",
    pubDate: "2024-10-23",
  ...
  },
  {
    ...
    summary: "Data centers are helping decarbonize the energy system while enabling tools that make the grid more resilient.",
    duration: "00:39:36",
    pubDate: "2024-10-16",
  ...
  },
  {
    id: "s4e1",
    title: "Data on Fire",
    summary: "How can AI and data centers help us solve critical climate challenges?",
    duration: "00:40:18",
    pubDate: "2024-10-09",
  ...
  },
  {
    ...
    summary: "Where the Internet Lives is back for a fourth season, focusing on how data center infrastructure is critical for resilience.",
    duration: "00:02:51",
    pubDate: "2024-09-25",
  ...
  // ── Season 3 (2023) ──────────────────────────────────────────
  {
    ...
    summary: "Hanoi Hantrakul is a former AI resident at Google working on creative applications of machine learning for music.",
    duration: "00:24:02",
    pubDate: "2023-07-12",
  ...
  },
  {
    ...
    summary: "Mikko Green is an operations manager at Google's data center in Hamina, Finland — the very facility I'm joining in July 2026.",
    duration: "00:18:29",
    pubDate: "2023-06-28",
  ...
  },
  {
    ...
    summary: "Oregon Tradeswomen is an organization devoted to helping women like Sarah Hess build careers in construction trades.",
    duration: "00:18:47",
    pubDate: "2023-06-14",
  ...
  },
  {
    ...
    summary: "Google partnered with North Water, a Dutch water treatment company, to harness water from canals to cool its data center.",
    duration: "00:17:13",
    pubDate: "2023-05-31",
  ...
  },
  {
    ...
    summary: "Ian is an operations engineer at Google's data center in Changhua County, Taiwan.",
    duration: "00:18:42",
    pubDate: "2023-05-17",
  ...
  },
  {
    ...
    summary: "Data centers are the latest in a long list of big projects that Dave Moody has tackled over three decades.",
    duration: "00:17:48",
    pubDate: "2023-05-03",
  ...
  },
  {
    ...
    summary: "As the digital tools behind solar get more sophisticated, data centers have the potential to be the backbone of the clean energy economy.",
    duration: "00:14:02",
    pubDate: "2023-04-19",
  ...
  },
  {
    ...
    summary: "Communities like Lenoir are often seen as great sites for data centers because of their strong industrial histories.",
    duration: "00:15:21",
    pubDate: "2023-04-05",
  ...
  },
  {
    ...
    summary: "Exploring how data centers are transforming rural communities and bringing new economic opportunities.",
    duration: "00:16:00",
    pubDate: "2023-03-22",
